#!/bin/bash
#
# StableClaw-Termux Installer
# One-liner: curl -fsSL https://raw.githubusercontent.com/ctz168/stableclaw_android/main/install.sh | bash
#
...
echo -e "${BLUE}"
echo "╔═══════════════════════════════════════════╗"
echo "║     StableClaw-Termux Installer            ║"
...
# Install stableclaw via npm
echo -e "\n${BLUE}[2/2]${NC} Installing stableclaw..."
...
echo "  1. Run setup:      stableclawx setup"
echo "  2. Run onboarding: stableclawx onboarding"
echo "     → Select 'Loopback (127.0.0.1)' when asked!"
echo "  3. Start gateway:  stableclawx start"
echo ""
