...
/// Reads and writes AI provider configuration in stableclaw.json.
class ProviderConfigService {
  static const _configPath = '/root/.stableclaw/stableclaw.json';
  ...
  static Future<void> saveProviderConfig({
    ...
    // not a bare string. StableClaw expects: models: [{ id: "model-name" }].
