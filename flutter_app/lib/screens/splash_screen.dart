    ...
    try {
      ...
      try {
        ...
        if (oldVersion != null && oldVersion != AppConstants.version) {
          ...
          if (hasPermission) {
            ...
            final snapshotPath = '$sdcard/Download/stableclaw-snapshot-$oldVersion.json';
      ...
      if (!setupComplete) {
        try {
          ...
          final stableclawOk = status['stableclawInstalled'] == true;
          ...
          if (rootfsOk && bashOk) {
            ...
            // Reinstall stableclaw if package.json is missing (#97)
            if (!stableclawOk && nodeOk) {
              setState(() => _status = 'Reinstalling StableClaw...');
              try {
