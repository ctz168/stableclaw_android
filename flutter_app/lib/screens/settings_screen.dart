...
class _SettingsScreenState extends State<SettingsScreen> {
      ...
      body: _loading
          ...
          : ListView(
              children: [
                ...
                ListTile(
                  title: const Text('StableClaw'),
                  subtitle: Text(_status['stableclawInstalled'] == true
                      ? 'Installed'
                      : 'Not installed'),
                ...
                ListTile(
                  ...
                  subtitle: const Text('ctz168/stableclaw_android'),
                  leading: const Icon(Icons.code),
                ...
                ListTile(
                  ...
                  subtitle: const Text('ctz168 Apps'),
  ...
  Future<String> _getSnapshotPath() async {
    ...
    if (hasPermission) {
      ...
      return '$sdcard/Download/stableclaw-snapshot.json';
    }
    // Fallback to app-private directory
    final dir = await getApplicationDocumentsDirectory();
    return '${dir.path}/stableclaw-snapshot.json';
  }

  Future<void> _exportSnapshot() async {
    try {
      final stableclawJson = await NativeBridge.readRootfsFile('root/.stableclaw/stableclaw.json');
      final snapshot = {
        'version': AppConstants.version,
        'timestamp': DateTime.now().toIso8601String(),
        'stableclawConfig': stableclawJson,
  ...
  Future<void> _importSnapshot() async {
    try {
      ...
      // Restore stableclaw.json into rootfs
      final stableclawConfig = snapshot['stableclawConfig'] as String?;
      if (stableclawConfig != null) {
        await NativeBridge.writeRootfsFile('root/.stableclaw/stableclaw.json', stableclawConfig);
      }
