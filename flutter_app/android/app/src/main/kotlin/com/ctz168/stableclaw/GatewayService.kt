...
class GatewayService : Service() {
    companion object {
        const val CHANNEL_ID = "stableclaw_gateway"
        ...
        gatewayThread = Thread {
            try {
                ...
                synchronized(lock) {
                    ...
                    gatewayProcess = pm.startProotProcess("stableclaw gateway --verbose")
                }
                updateNotificationRunning()
    ...
    private fun stopGateway() {
        ...
        // handler to kill child processes (node.js / stableclaw daemon) before proot
    ...
    private fun createNotificationChannel() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            val channel = NotificationChannel(
                ...
                description = "Keeps the StableClaw gateway running in the background"
            }
    ...
    private fun buildNotification(text: String): Notification {
        ...
        builder.setContentTitle("StableClaw Gateway")
            .setContentText(text)
